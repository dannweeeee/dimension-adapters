...
const meteoraGlobalMetricsEndpoint =
  "https://dammv2-api.meteora.ag/pools/global-metrics";
...
async function fetch() {
  try {
    ...
    const dailyFees =
      ...
      dailyPartnerRevenue +
      dailyReferralRevenue;

    // Total revenue = Protocol + Partner + Referral (excluding LP fees)
    const dailyRevenue =
      dailyProtocolRevenue + dailyPartnerRevenue + dailyReferralRevenue;
